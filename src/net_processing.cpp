...
void static ProcessGetData(CNode* pfrom, const Consensus::Params& consensusParams, CConnman& connman, CThreadInterrupt& interruptMsgProc)
{
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived, const CChainParams& chainparams, CConnman& connman, CThreadInterrupt& interruptMsgProc)
{
    unsigned int nMaxSendBufferSize = connman.GetSendBufferSize();
...
bool ProcessMessages(CNode* pfrom, CConnman& connman, CThreadInterrupt& interruptMsgProc)
{
...
bool SendMessages(CNode* pto, CConnman& connman, CThreadInterrupt& interruptMsgProc)
{
