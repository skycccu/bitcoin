...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-addudpnode=<ip/host>:<port>,<local_magic>,<remote_magic>", _("Add a persistent UDP node, see RPC addudpnode for detailed description"));
    strUsage += HelpMessageOpt("-addtrustedudpnode=<ip/host>:<port>,<local_magic>,<remote_magic>", _("Add a trusted, persistent UDP node, see RPC addudpnode for detailed description"));
    ...
    strUsage += HelpMessageOpt("-udpport=<port>", _("Accepts UDP connections on <port> (default: 0=disabled)"));
