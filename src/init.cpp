...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-recenttxcachesize=<n>", strprintf(_("Extra memory (in KB) used to cache recently-rejected txn for block reconstructions (default: %u)"), DEFAULT_RECENT_TXN_CACHE_SIZE));
