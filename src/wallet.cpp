...
//XXX: Might be more optimal to waste low-prio inputs if we are just going to pay a fee anyway
                ...
                BOOST_FOREACH(PAIRTYPE(const CWalletTx*, unsigned int) pcoin, setCoins)
                {
                    ...
                    //reflecting the fact that the priority will only be checked when it is
                    //considered for inclusion in the next block.
                ...
                int64 nMinFee = wtxNew.GetMinFee(dPriority);
