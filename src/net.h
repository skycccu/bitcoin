...
struct CNodeSignals
{
    boost::signals2::signal<bool (CNode*, CConnman&, bool), CombinerAll> ProcessMessages;
...
public:
    ...
    std::atomic_bool fFeeler; // If true this node is being used as a short lived feeler.
    bool fOneShot;
    bool fClient;
    const bool fInbound;
    ...
    std::atomic_bool fRelayTxes; //protected by cs_filter
    bool fSentAddr;
...
public:
    ...
    std::atomic_int nStartingHeight;
