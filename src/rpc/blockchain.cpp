...
UniValue blockheaderToJSON(const CBlockIndex* blockindex)
{
    ...
    result.push_back(Pair("chainwork", arith_uint256(blockindex->nChainWork).GetHex()));
...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    obj.push_back(Pair("chainwork",             arith_uint256(chainActive.Tip()->nChainWork).GetHex()));
